...
export default function About() {
  ...
  return (
    <section id="about" className="min-h-screen  py-20">
        ...
        <h1 className=" text-xl font-bold text-center mb-10 m-10">ABOUT ME</h1>
        <div className="flex flex-col md:flex-row items-center justify-between  p-10 gap-8">
          ...
          <div   data-aos="fade-left"    className="  text-center md:text-left flex-1 p-5"  >
            ...
            <ul className="p-5 gap-5 flex flex-col">
              <li className="flex gap-3 items-center">
                <GraduationCap className="rounded-xl bg-black dark:bg-white text-white dark:text-black items-center p-1" size={30} />
                University Of Caloocan City - Congress Campus
              </li>

              <li className="flex gap-3 items-center">
                <Briefcase className="rounded-xl bg-black dark:bg-white text-white dark:text-black items-center p-1" size={30} />
                Web Full Stack Developer - Intracode It Solutions
              </li>

              <li className="flex gap-3 items-center">
                <MapPinHouse className="rounded-xl bg-black dark:bg-white text-white dark:text-black items-center p-1" size={30} />
                Caloocan City - Philippines
              </li>

              <li className="flex gap-3 items-center">
                <Contact className="rounded-xl bg-black dark:bg-white text-white dark:text-black items-center p-1" size={30} />
                +63 948 609 6986 | +63 993 632 2360
              </li>

              <li className="flex gap-3 items-center">
                <Mail className="rounded-xl bg-black dark:bg-white light:bg-black text-white dark:text-black items-center p-1" size={30} />
                karl.brizuela01@gmail.com
              </li>
            </ul>
              
               <p className=" text-center">“I can do all things through God who strengthens me.”
